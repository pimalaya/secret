# Secret flows [![Documentation](https://img.shields.io/docsrs/secret-flows)](https://docs.rs/secret-flows/latest/secret_flows/) [![Matrix](https://img.shields.io/matrix/pimalaya:matrix.org?color=success&label=chat)](https://matrix.to/#/#pimalaya:matrix.org)
